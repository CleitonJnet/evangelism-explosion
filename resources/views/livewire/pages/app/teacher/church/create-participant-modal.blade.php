<div>
    <flux:modal name="teacher-church-create-participant-modal" wire:model="showModal" class="max-w-4xl w-[calc(100%-4px)] mx-auto p-0! max-h-[calc(100vh-4px)]! overflow-hidden">
        <div>
            ...
            <div class="space-y-6 px-6 py-6">
                ...
                <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <div class="flex flex-wrap items-end gap-4">
                        <x-src.form.input type="email" name="teacher-church-participant-identify-email" wire:model.blur="email"
                        ...
                        <form wire:submit="registerParticipant" class="space-y-8">
                            <section class="space-y-5">
                                ...
                                <div class="flex flex-wrap gap-x-4 gap-y-8">
                                    <x-src.form.select name="teacher-church-participant-ispastor" wire:model="ispastor"
                                        label="É pastor?" width_basic="90" :select="false" value="0" :options="$yesNoOptions" />

                                    <x-src.form.input name="teacher-church-participant-name" wire:model="name"
                                        label="Nome completo" type="text" width_basic="400" :required="! $existingUserId" />

                                    <x-src.form.input type="tel" name="teacher-church-participant-mobile" wire:model="mobile"
                                        data-no-tel-mask label="Celular &#10023; WhatsApp" width_basic="200" :required="! $existingUserId" />

                                    <x-src.form.input type="email" name="teacher-church-participant-email" wire:model="email"
                                        label="E-mail" width_basic="350" required />

                                    <x-src.form.input type="date" name="teacher-church-participant-birth-date" wire:model="birth_date"
                                        label="Data de Nascimento" width_basic="200" />

                                    <x-src.form.select name="teacher-church-participant-gender" wire:model="gender"

<div>
    <flux:modal name="teacher-create-church-modal" wire:model="showModal" class="max-w-5xl w-[calc(100%-4px)] mx-auto bg-sky-950! p-0! max-h-[calc(100vh-4px)]! overflow-hidden"
                ...
                <div class="space-y-8">
                    <section class="space-y-5">
                        ...
                        <div class="flex flex-wrap items-start gap-6">
                            <div class="grid gap-2">
                                <input id="teacher-church-logo-upload" type="file" accept="image/*"
                                    wire:model.live="logoUpload" class="sr-only">

                                <label for="teacher-church-logo-upload"
                    ...
                    <section class="space-y-5">
                        ...
                        <livewire:address-fields wire:model="churchAddress" title="Endereço da igreja"
                            wire:key="teacher-church-create-address" />
                    </section>

    ...
    <section
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 pb-2">
            <div class="flex flex-col gap-1">
                ...
                <p class="text-sm text-slate-500">{{ __('Slogan:') }} {{ $course?->slogan ?? __('Não informado') }}
                </p>
            </div>
            <div class="flex flex-wrap items-center gap-2">
                <span class="rounded-lg bg-yellow-200/70 px-4 py-2 text-xs font-semibold text-yellow-900 text-center">
                    <div>{{ __('Evento') }}</div>
                    {{ $statusLabel }}
                </span>
            </div>
        ...
        <div class="mt-6 grid gap-6 lg:flex flex-wrap">
            <div class="rounded-2xl border border-slate-800/40 bg-white/90 p-4 basis-2/3 flex-auto">
                <h3 class="text-sm font-semibold text-slate-900 uppercase border-b pb-2 mb-2">{{ __('Igreja Base') }}
                </h3>
            ...
            <div
                ...
                <h4 class="text-sm font-semibold text-slate-900 uppercase border-b pb-2 mb-2">
            ...
            <div class="rounded-2xl border border-slate-800/40 bg-white/90 p-4 flex-auto">
                <h3 class="text-sm font-semibold text-slate-900 uppercase text-center border-b pb-2 mb-2">
                    {{ __('Indicadores') }}
                </h3>
            ...
            <div class="rounded-2xl border border-slate-800/40 bg-white/90 p-4 flex-auto">
                <h4 class="text-sm font-semibold text-slate-900 uppercase border-b pb-2 mb-2">{{ __('OJT Summary') }}
                </h4>
                <div class="mt-3 grid gap-3 text-sm text-slate-700">
                    <div class="flex items-center justify-between gap-4">
            ...
            <div class="rounded-2xl border border-slate-800/40 bg-white/90 p-4 flex-auto">
                ...
                <h4 class="text-sm font-semibold text-slate-900 uppercase border-b pt-4 pb-2 mb-2">

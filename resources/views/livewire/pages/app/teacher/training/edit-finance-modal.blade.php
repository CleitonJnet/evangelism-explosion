...
<div>
    <flux:modal name="edit-finance-modal" wire:model="showModal" class="max-w-5xl w-[calc(100%-4px)] mx-auto bg-sky-950! p-0! max-h-[calc(100vh-4px)]! overflow-hidden">
                ...
                <div class="grid gap-10">
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        <div class="grid gap-3 rounded-xl border border-slate-300 bg-white/70 p-4">
                            ...
                            <input id="event-church-pix-qr-upload-modal-{{ $training->id }}" type="file"
                                accept="image/*" wire:model.live="pixQrCodeUpload" class="sr-only">

<div>
    <flux:modal name="edit-event-dates-modal" wire:model="showModal" class="max-w-5xl w-full bg-sky-950! text-white! p-0!">
        <div class="">
            <div class="px-8 py-4 text-lg font-semibold text-heading">{{ __('Datas do treinamento') }}</div>
            <div class="px-8 py-4 bg-slate-50 flex items-center justify-end">
                <x-src.btn-silver wire:click="addEventDate" :label="__('Adicionar dia')" />
            </div>
            <div class="max-h-[calc(100vh-200px)] grid gap-8 p-8 bg-slate-50 text-slate-950 overflow-y-auto">

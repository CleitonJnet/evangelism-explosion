        ...
        <div class="flex h-[min(90vh,52rem)] flex-col overflow-hidden rounded-2xl">
            <header class="sticky top-0 z-20 border-b border-sky-800 bg-sky-950 px-6 py-4 text-sky-50">
                ...
                <p class="text-sm opacity-90">
                    {{ __('Configure o estoque central ou o estoque local de um professor com dados operacionais básicos.') }}
                </p>
            </header>
                ...
                <div class="space-y-8 pb-2">
                    <section class="space-y-5">
                        <div class="flex flex-wrap gap-x-4 gap-y-8">
                            ...
                            <x-src.form.select name="director-inventory-create-status" wire:model.live="status"

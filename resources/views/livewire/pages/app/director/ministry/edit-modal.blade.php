<div>
    <flux:modal name="director-edit-ministry-modal" wire:model="showModal" class="max-w-3xl w-[calc(100%-4px)] mx-auto bg-sky-950! p-0! max-h-[calc(100vh-4px)]! overflow-hidden">
        <div class="flex max-h-[90vh] flex-col overflow-hidden rounded-2xl">
            <header class="sticky top-0 z-20 border-b border-sky-800 bg-sky-950 px-6 py-4 text-sky-50">
                <h3 class="text-lg font-semibold">{{ __('Editar ministério') }}</h3>
                <p class="text-sm opacity-90">
                    {{ __('Atualize os dados do ministério mantendo os cursos relacionados.') }}
                </p>
            </header>
                        ...
                        <div class="grid gap-6 lg:grid-cols-12">
                            <div class="lg:col-span-4">
                                <div class="grid justify-items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 p-4">
                                    <input id="director-ministry-edit-logo-upload" type="file" accept="image/*"
                                        wire:model.live="logoUpload" class="sr-only">

                                    <label for="director-ministry-edit-logo-upload"
                            ...
                            <div class="space-y-6 lg:col-span-8">
                                <div class="flex flex-wrap gap-x-4 gap-y-8">
                                    ...
                                    <div class="relative z-0 max-w-full group" style="flex: 1 0 220px">
                                        <input id="director-ministry-edit-color" type="color" wire:model.live="color"
                                            class="sr-only">
                                        <label for="director-ministry-edit-color"

<div>
    <flux:modal name="director-edit-church-modal" wire:model="showModal" class="max-w-5xl w-[calc(100%-4px)] mx-auto bg-sky-950! p-0! max-h-[calc(100vh-4px)]! overflow-hidden"
        ...
        <div class="flex max-h-[90vh] flex-col overflow-hidden rounded-2xl">
            <header class="sticky top-0 z-20 border-b border-sky-800 bg-sky-950 px-6 py-4 text-sky-50">
                <h3 class="text-lg font-semibold">{{ __('Editar igreja') }}</h3>
                <p class="text-sm opacity-90">
                    {{ __('Atualize os dados da igreja com segurança e mantenha o cadastro completo.') }}
                </p>
            </header>
                ...
                <div class="space-y-8">
                    <section class="space-y-5">
                        ...
                        <div class="flex flex-wrap items-start gap-6">
                            <div class="grid gap-2">
                                <input id="director-church-logo-edit-upload" type="file" accept="image/*"
                                    wire:model.live="logoUpload" class="sr-only">

                                <label for="director-church-logo-edit-upload"
                                ...
                                <p class="text-xs text-slate-600">{{ __('Clique na imagem para trocar a logo.') }}</p>
                    ...
                    <section class="space-y-5">
                        ...
                        <livewire:address-fields wire:model="churchAddress" title="Endereço da igreja"
                            wire:key="director-church-edit-address-{{ $churchId }}" />
                    </section>

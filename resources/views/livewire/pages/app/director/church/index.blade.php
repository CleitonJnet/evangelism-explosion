<div>
                    ...
                    <div class="max-h-96 overflow-y-auto p-2">
                        ...
                        <section>
                            ...
                            @forelse ($userSearchResults as $userResult)
                                <a href="{{ route('app.director.church.profiles.show', $userResult) }}"
                                    class="mb-1 flex items-center gap-3 rounded-xl px-2 py-2 transition hover:bg-slate-100">
    ...
    <flux:modal name="director-all-users-modal" wire:model="showAllUsersModal" class="max-w-[92vw] w-[calc(100%-4px)] mx-auto bg-sky-950! p-0! max-h-[calc(100vh-4px)]! overflow-hidden">
                                ...
                                @forelse ($allUsers as $listedUser)
                                    @php
                                        $completedCourses = $listedUser->trainings
                                            ...
                                            ->values();
                                    @endphp
                                    <tr wire:key="director-all-user-{{ $listedUser->id }}"
                                        class="cursor-pointer odd:bg-white even:bg-slate-50/80 hover:bg-sky-50/70 transition"
                                        data-row-link="{{ route('app.director.church.profiles.show', $listedUser) }}"
                                        x-on:click="window.location = $el.dataset.rowLink">
                                        <td class="px-3 py-3 align-middle">
                                            <div class="flex justify-center">
    ...
    <flux:modal name="director-unlinked-user-modal" wire:model="showUnlinkedUserModal"
        class="max-w-5xl w-[calc(100%-4px)] mx-auto bg-sky-950! p-0! max-h-[calc(100vh-4px)]! overflow-hidden">
        <div class="flex max-h-[90vh] flex-col overflow-hidden rounded-2xl">
            <div class="sticky top-0 z-20 border-b border-sky-800 bg-sky-950 px-6 py-4">

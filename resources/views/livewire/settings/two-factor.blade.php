    ...
    public function getModalConfigProperty(): array
    {
        if ($this->twoFactorEnabled) {
            return [
                ...
                'description' => __('A autenticação em dois fatores está ativa. Escaneie o QR code ou informe a chave no seu app autenticador.'),
                'buttonText' => __('Close'),
            ];
        }
        ...
        return [
            ...
            'description' => __('Para concluir, escaneie o QR code ou informe a chave no seu app autenticador.'),
            'buttonText' => __('Continue'),
        ];
    }
}; ?>
    ...
    @else
        <div class="flex flex-col gap-6 rounded-2xl border border-[color:var(--ee-app-border)] bg-[color:var(--ee-app-surface)] p-6">
            <div class="flex items-center justify-between gap-4">
                <flux:heading size="sm" level="2">{{ __('Two-Factor Auth') }}</flux:heading>
                <flux:badge color="{{ $twoFactorEnabled ? 'green' : 'red' }}">
        ...
        <div class="space-y-6">
            ...
            <div class="space-y-4">
                <div class="relative flex items-center justify-center w-full">
                    ...
                    <span
                        class="relative px-2 text-sm bg-white text-stone-600">

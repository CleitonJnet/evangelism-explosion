...
<section class="w-full">
    ...
    <x-app.settings.layout :heading="__('Update password')" :subheading="__('Ensure your account is using a long, random password to stay secure')">
        <form method="POST" wire:submit="updatePassword" class="mt-6 space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <x-app.action-message class="me-3" on="password-updated">
                    {{ __('Saved.') }}

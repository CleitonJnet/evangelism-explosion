...
<div>
    ...
    <x-src.toolbar.nav>
        ...
        <x-src.toolbar.button :href="route($this->contextRoute('stpBoard'), $training)" :label="__('Visitas')" icon="list" :tooltip="__('Distribuição de visitas STP')" />
        @if ($capabilities['canManageMentors'])

                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <a href="{{ route('web.home') }}" class="flex items-center h-full gap-3">
                        ...
                        <div class="leading-tight">
                            ...
                            <div
                                class="hidden min-[345px]:flex min-[345px]:items-center min-[345px]:gap-1 text-xs font-bold bg-linear-to-r from-[#fff4c6] via-[#c19b29] to-[#9a802a] bg-clip-text text-transparent tracking-wide">
                                NO BRASIL <span style="font-size: 9px;">&#10023;</span> <span
                                    class="text-white font-light opacity-70">Até
                                    QueTodos Ouçam!</span>
                            </div>
                        </div>
                    </a>

<x-layouts.app :title="__('OJT Statistics')">
    <x-src.toolbar.bar :title="__('On-The-Job Training')" :description="__('Review OJT statistics for this training.')">
    ...
    <div class="mt-6">
        <livewire:pages.app.teacher.training.ojt.statistics :training="$training" mode="summary" />
    </div>
</x-layouts.app>

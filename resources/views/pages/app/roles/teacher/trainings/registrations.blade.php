<x-layouts.app :title="__('Gerenciamento de inscricoes')">
    <x-src.toolbar.header :title="__('Gerenciamento de inscricoes')" :description="__(
        'Acompanhe e atualize os status dos inscritos deste evento, com os participantes agrupados por igreja.',
    )" />
    <x-src.toolbar.nav :title="__('Gerenciamento de inscricoes')" :description="__('Atualize comprovante, credenciamento e entrega de kit com poucos cliques.')" justify="justify-between">

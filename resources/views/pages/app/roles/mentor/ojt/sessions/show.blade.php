<x-layouts.app :title="__('Sessão STP')">
    <x-src.toolbar.header :title="__('Sessão STP')" :description="__('Detalhes somente leitura da sessão e das equipes vinculadas à sua mentoria.')" />
    <x-src.toolbar.nav>
        ...
        <x-src.toolbar.button :href="route('app.mentor.trainings.ojt', $session->training)" :label="__('STP')" icon="users-chat" />
    </x-src.toolbar.nav>

<x-layouts.app :title="__('Treinamento do Mentor')">
    <x-src.toolbar.header :title="__('Visão do treinamento')" :description="__('Dados básicos do evento e resumo seguro da prática STP/OJT vinculada à sua mentoria.')" />
    <x-src.toolbar.nav>
        ...
        <x-src.toolbar.button :href="route('app.mentor.trainings.ojt', $training)" :label="__('STP/OJT')" icon="users-chat" :active="request()->routeIs('app.mentor.trainings.ojt')" />
    </x-src.toolbar.nav>

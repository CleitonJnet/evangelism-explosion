<x-layouts.app :title="__('Detalhes do estoque')">
    ...
    <div x-data="{ hasActiveSimpleMaterials: @js($hasActiveSimpleMaterials) }"
        ...
        <x-src.toolbar.nav>
            ...
            <div x-show="!hasActiveSimpleMaterials" x-cloak>
                <x-src.toolbar.button href="#" :label="__('Novo composto')"
                    icon="squares-2x2"
                    :tooltip="__('Cadastre ou mantenha pelo menos um item simples ativo para liberar produtos compostos')"

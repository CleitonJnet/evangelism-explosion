...
class CreateParticipantModal extends Component
{
    ...
    #[On('open-director-church-participant-create-modal')]
    ...
    {
        return view('livewire.pages.app.director.church.create-participant-modal', [
    ...
    public function registerParticipant(ChurchParticipantRegistrationProcessor $processor): void
    {
        ...
        try {
            ...
            $this->dispatch('director-church-participant-created', churchId: $church->id);
            $this->closeModal();
        } finally {
            $this->busy = false;
        }

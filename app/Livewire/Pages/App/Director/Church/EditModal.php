...
class EditModal extends Component
{
    ...
    #[On('open-director-church-edit-modal')]
    ...
    public function save(): void
    {
        ...
        try {
            ...
            $this->dispatch('director-church-updated', churchId: $this->churchId);
            $this->closeModal();
        } finally {
            $this->busy = false;
        }
    ...
    {
        return view('livewire.pages.app.director.church.edit-modal', [

...
class Edit extends Component
{
    ...
    public function mount(Church $church): void
    {
        ...
        $this->church_contact = $church->contact;
        $this->church_contact_phone = $church->contact_phone;
    ...
    {
        $this->authorize('update', $this->church);
        ...
        session()->flash('success', __('Igreja atualizada com sucesso.'));

        $this->redirectRoute('app.director.church.show', ['church' => $this->church->id]);
    }

    public function render(): View
    {
        return view('livewire.pages.app.director.church.edit');
    }
}

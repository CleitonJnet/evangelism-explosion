...
class CreateModal extends Component
{
    ...
    #[On('open-teacher-church-create-modal')]
    ...
    public function save(): void
    {
        ...
        try {
            $church = DB::transaction(function () use ($validated, $user): Church {
                $logoPath = null;
                ...
                $church->missionaries()->syncWithoutDetaching([$user->id]);

                return $church;
            });

            $this->dispatch('teacher-church-created', churchId: $church->id, churchName: $church->name);
    ...
    {
        return view('livewire.pages.app.teacher.church.create-modal', [

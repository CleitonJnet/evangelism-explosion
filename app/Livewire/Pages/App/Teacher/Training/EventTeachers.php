...
class EventTeachers extends Component
{
    ...
    private function persistChanges(array $validated): mixed
    {
        ...
        if (Auth::id() !== $newTeacherId) {
            session()->flash('success', __('Professor titular atualizado. Você não possui mais acesso a este treinamento.'));

            return $this->redirectRoute('app.teacher.trainings.index');
        }
    ...
    public function render(): View
    {
        ...
        return view('livewire.pages.app.teacher.training.event-teachers', [

...
abstract class StatisticsPage extends Component
{
    ...
    {
        return view('livewire.shared.training.statistics-page');
    }
    ...
    {
        $metrics = app(TrainingDiscipleshipMetricsService::class)->buildTrainingBoard($this->training, $this->activeSessionId);

        $this->training = $this->training->fresh(['course']);
        $this->mentorsCount = $metrics['mentorsCount'];
        $this->isLeadershipExecutionTraining = $metrics['isLeadershipExecutionTraining'];
        $this->sessions = $metrics['sessions'];
        $this->activeSessionId = $metrics['activeSessionId'];
        $this->pendingStudents = $metrics['pendingStudents'];
        $this->canCreateSession = $metrics['canCreateSession'];
    ...
    {
        $metrics = app(TrainingDiscipleshipMetricsService::class)->buildCreateSessionState($this->training);
    ...
    {
        return app(TrainingDiscipleshipMetricsService::class)->formatSessionLabel($session);
    }

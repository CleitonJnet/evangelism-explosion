...
1. `Director` sempre pode ver, editar, excluir e acessar STP, dados sensiveis e financas.
...
5. `Mentor` pode ver STP do treinamento vinculado, mas nao ve financas nem dados sensiveis.
